const _ALGO_HELP_MSG_ = """algorithm (ISRES | PRAXIS | SBPLX | SLSQP | LBFGS | AUGLAG | Newton | Anneal)
  ...
  SLSQP   -   Sequential quadratic programming for nonlineraly constrained,
              gradient-based optimizationa
  LBFGS   -   low-storage BFGS; gradient-based unconstrained optimization
  AUGLAG  -   Augmented Lagrangian; constrained optimization with LBFGS
